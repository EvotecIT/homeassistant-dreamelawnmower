...
build_operation_stage_diagnostics = (
    _client_camera.build_operation_stage_diagnostics
)
camera_metadata_advertises_video = (
    _client_camera.camera_metadata_advertises_video
)
camera_stream_block_reason = _client_camera.camera_stream_block_reason
derive_tx_video_app_credentials = (
    _client_camera.derive_tx_video_app_credentials
)
...
class DreameLawnMowerClient(_DreameLawnMowerCameraMixin):
