...
from .app_map_rendering import (
    _app_map_coordinate_sets as _app_map_coordinate_sets,
)
from .app_map_rendering import (
    _app_map_entry_label as _app_map_entry_label,
)
from .app_map_rendering import (
    _app_map_label_font as _app_map_label_font,
)
from .app_map_rendering import (
    _app_map_points as _app_map_points,
)
from .app_map_rendering import (
    _app_map_polygon_center as _app_map_polygon_center,
)
from .app_map_rendering import (
    _draw_app_map_label as _draw_app_map_label,
)
from .app_map_rendering import (
    _is_app_map_pathway as _is_app_map_pathway,
)
from .app_map_rendering import (
...
from .app_map_rendering import (
    render_app_map_payload_png as render_app_map_payload_png,
)
...
def _select_app_map_payload(app_maps: Mapping[str, Any]) -> Mapping[str, Any] | None:
    ...
    if current_idx is not None:
        # Never replace a failed current-map download with a different lawn.
        return None
