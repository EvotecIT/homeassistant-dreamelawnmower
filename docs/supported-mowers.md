...
| MOVA VIAX 300 | `mova.mower.g2420b` | **Field-reported** | Owner confirmed the raw model ID on firmware `4.3.6_0482` with a MOVAhome account in region `sg`, and reported zero for the mowing-preference height field. [MOVA documents manual 2–6 cm adjustment](https://pl.mova.tech/products/viax300-robot-lawn-mower). Other preference writes need owner validation after the height fix. |
