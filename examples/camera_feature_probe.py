"""Read-only probe for Dreame mower camera/photo support.

This intentionally does not start video, audio, camera lights, or photo capture.
It only inspects metadata and protocol mappings so we can decide what is safe to
test next.
"""
